...
var removed = waitingList.remove(at: 0)

admitted.append(removed)
//: ### Exercise 7
...
var food = ["Anchovies":false, "Coconut":true, "Liver":false]
...
presidentialPetsDict["George W. Bush"] = "Millie"
...
if presidentialPetsDict["George Bush"] != nil{
