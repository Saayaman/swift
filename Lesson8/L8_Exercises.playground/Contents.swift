...
class Teenager:Babysitter {
    ...
    func read(_ book: String, firstLine: String, asleep: Bool) -> Bool {
        ...
        print("The teenater started reading \(book). \"\(firstLine)\"... ")
        if asleep {
            return true
        } else {
            return false
    ...
    func playCandyland(_ numberOfTimes: Int) {
        print("They played Candyland \(numberOfTimes) times!")
    }
}
...
var teenager1 = Teenager(age: 14, responsible: true, patience: .low)
teenager1.playCandyland(10)
var readings = teenager1.read("Sleeping Beaty", firstLine: "Once upon a time", asleep: true)

if readings{
    print("The child has slept")
} else{
    print("The child kept crying")
}
//: __Problem 2__
//:
...
class Animal:Adorable {
    ...
    init(species: String, numberOfLegs: Int, softFur:Bool, size:Size) {
    ...
    func frolick() {
     print("func frolick is executed")
    }
    
    
    func curlIntoSmallBall() {
        print("curlIntoSmallBall is executed")
    }
}

var pic = UIImage(named: "frolick.jpg")
var animal1 = Animal(species: "Camel", numberOfLegs: 4, softFur: true, size: .large)

animal1.frolick()
animal1.curlIntoSmallBall()
//: __Problem 3__
//:
...
class ScrubJay:Hoarder {
    func pilfer() -> String {
        return "This is Scrubjay!"
    }

    func cache(_ foodItem: String) -> String {
        return "This is scrubjay little \(foodItem)s."
    }
...
var scrub = ScrubJay(female: true)
print(scrub.cache("I love what i do"))
print(scrub.pilfer())
...
extension Minion: DirtyDeeds{
    func cheat() {
        print("The \(name) cheats")
    }
    
    func steal() {
        print("The \(name) steals")
    }
}


var minion1 = Minion(name: "Snake")
minion1.cheat()
minion1.steal()
...
extension UIColor
{
    ...
    //this is an initializer of UIColor method overloading
    ...
    func pistachio() -> UIColor{
        return UIColor(red: 147, green: 197, blue: 114, alpha: 1.0)
    }
